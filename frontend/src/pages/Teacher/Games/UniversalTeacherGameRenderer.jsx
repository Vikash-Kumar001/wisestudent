...
import teacherGameCategories, { getTeacherGame } from './index';
...
const UniversalTeacherGameRenderer = () => {
  ...
  useEffect(() => {
    console.log('Loading teacher game:', { category, gameId });
    ...
    const catData = teacherGameCategories[category];
    if (!catData) {
    ...
    const GameComponent = getTeacherGame(category, gameId);
