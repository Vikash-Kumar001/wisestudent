...
const InterventionRoleplay = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Someone says: 'Boys are stronger.' How do you intervene effectively and safely?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 2,
      text: "Someone says: 'Girls talk too much.' How do you intervene effectively?",
      options: [
        { 
          id: "b", 
    ...
    {
      id: 3,
      text: "Someone says: 'Men don't do housework.' How do you respond?",
      options: [
        { 
          id: "a", 
    ...
    {
      id: 4,
      text: "Someone says: 'Women are too emotional.' How do you intervene?",
      options: [
        { 
          id: "b", 
    ...
    {
      id: 5,
      text: "Someone says: 'Boys like blue, girls like pink.' How do you intervene?",
      options: [
        { 
          id: "a", 
