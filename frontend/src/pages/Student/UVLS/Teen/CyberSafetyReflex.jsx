...
const CyberSafetyReflex = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "Is this post abusive? 'Abusive comment targeting someone.'",
      correctAnswer: "Yes, Report",
      options: [
    ...
    {
      id: 3,
      question: "Is this post abusive? 'Trolling meme meant to hurt someone.'",
      correctAnswer: "Yes, Report",
      options: [
        { text: "Maybe", isCorrect: false, emoji: "🤷" },
        { text: "Yes, Report", isCorrect: true, emoji: "🚨" },
    ...
    {
      id: 4,
      question: "Is this post abusive? 'Normal share about daily activities.'",
      correctAnswer: "No, Ignore",
      options: [
        { text: "Don't Know", isCorrect: false, emoji: "❓" },
        { text: "Maybe", isCorrect: false, emoji: "🤷" },
    ...
    {
      id: 5,
      question: "Is this post abusive? 'Hate speech targeting a group.'",
      correctAnswer: "Yes, Report",
      options: [
        { text: "Yes, Report", isCorrect: true, emoji: "🚨" },
        { text: "Don't Know", isCorrect: false, emoji: "❓" },
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Identify unsafe content!` : "Identify unsafe online content!"}
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Identify unsafe or abusive online content quickly!<br />
