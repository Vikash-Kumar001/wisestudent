...
const NoteTakingStory = () => {
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Note-taking Story game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
