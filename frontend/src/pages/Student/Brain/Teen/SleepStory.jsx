...
const SleepStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Teen sleeps 5 hrs before exam, feels tired. Is this good?",
      choices: [
        { id: 'a', text: 'No, insufficient sleep affects performance' },
        { id: 'b', text: 'Yes, 5 hours is enough' },
        { id: 'c', text: 'Maybe, depends on the person' }
      ],
      correct: 'a',
      explanation: 'No! Teens need 8-10 hours of sleep for optimal brain function, memory consolidation, and exam performance!'
    },
    {
      id: 2,
      ...
      correct: 'a',
      explanation: 'Insufficient sleep impairs concentration, memory recall, and decision-making, significantly affecting exam performance!'
    },
    {
      id: 3,
    ...
    {
      id: 4,
      text: "What's the best sleep schedule before an exam?",
      choices: [
        { id: 'a', text: 'Consistent sleep schedule, 8-10 hours nightly' },
        { id: 'b', text: 'Stay up all night studying' },
        { id: 'c', text: 'Sleep only 3-4 hours' }
      ],
      correct: 'a',
      explanation: 'Maintaining a consistent sleep schedule with 8-10 hours helps your brain consolidate learning and perform at its best!'
    },
    {
      id: 5,
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Sleep Story game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
