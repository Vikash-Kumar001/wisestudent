...
const QuizOnDigitalBalance = () => {
  const location = useLocation();
  
  // Get game data from game category folder (source of truth)
  const gameId = "brain-teens-72";
  ...
  const questions = [
    {
      ...
      choices: [
        ...
        { id: 'c', text: 'Using gadgets constantly' }
      ],
      correct: 'a',
      explanation: 'Digital detox is taking intentional time away from electronic devices to reduce screen time and improve well-being!'
    },
    {
      id: 2,
      ...
      correct: 'a',
      explanation: 'Digital balance prevents screen addiction, improves sleep, enhances real-life relationships, and promotes overall well-being!'
    },
    {
      id: 3,
    ...
    {
      id: 4,
      text: "How can you achieve digital balance?",
      choices: [
        { id: 'a', text: 'Set screen time limits and take regular breaks' },
        { id: 'b', text: 'Use devices all day without limits' },
        { id: 'c', text: 'Never take breaks from screens' }
      ],
      correct: 'a',
      explanation: 'Achieving digital balance involves setting screen time limits, taking regular breaks, and prioritizing offline activities!'
    },
    {
      id: 5,
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Quiz on Digital Balance game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
...
export default QuizOnDigitalBalance;
