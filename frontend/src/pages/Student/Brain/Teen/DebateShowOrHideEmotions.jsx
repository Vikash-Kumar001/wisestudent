...
const DebateShowOrHideEmotions = () => {
  ...
  const questions = [
    {
      ...
      choices: [
        { id: 'a', text: 'No, express healthy' },
        { id: 'b', text: 'Yes, always hide' },
        { id: 'c', text: 'Only show positive emotions' }
      ],
      correct: 'a',
      explanation: 'Healthy expression of emotions builds connections, promotes mental health, and helps others understand you!'
    },
    {
      id: 2,
    ...
    {
      id: 4,
      text: "How should you handle emotions considering cultural norms?",
      choices: [
        { id: 'a', text: 'Balance cultural expectations with healthy expression' },
        { id: 'b', text: 'Always suppress emotions' },
        { id: 'c', text: 'Ignore cultural norms completely' }
      ],
      correct: 'a',
      explanation: 'While respecting cultural norms, it\'s important to find healthy ways to express emotions for your mental well-being!'
    },
    {
      id: 5,
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Debate: Show or Hide Emotions? game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
