...
const PhoneStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Teen uses phone till 2 AM, sleeps in class. Is this healthy?",
      choices: [
        { id: 'a', text: 'No, it disrupts sleep and learning' },
        { id: 'b', text: 'Yes, it\'s fine' },
        { id: 'c', text: 'Maybe, depends on the person' }
      ],
      correct: 'a',
      explanation: 'No! Using phones late at night disrupts sleep patterns, reduces sleep quality, and impairs focus and learning the next day!'
    },
    {
      id: 2,
      ...
      correct: 'a',
      explanation: 'Putting your phone away at least 1 hour before bed helps your brain wind down and improves sleep quality!'
    },
    {
      id: 3,
    ...
    {
      id: 4,
      text: "What's the best practice for phone use and sleep?",
      choices: [
        { id: 'a', text: 'Set phone to Do Not Disturb and keep it away from bed' },
        { id: 'b', text: 'Keep phone next to bed with notifications on' },
        { id: 'c', text: 'Check phone throughout the night' }
      ],
      correct: 'a',
      explanation: 'Setting Do Not Disturb and keeping your phone away from bed creates a better sleep environment and prevents disruptions!'
    },
    {
      id: 5,
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Phone Story game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
