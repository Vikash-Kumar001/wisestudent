...
const PeerPressureeStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Teen feels anxious when friends tease. Best step?",
      choices: [
        { id: 'a', text: 'Stay calm & talk' },
        { id: 'b', text: 'Get angry & yell back' },
        { id: 'c', text: 'Ignore and avoid them' }
      ],
      correct: 'a',
      explanation: 'Staying calm and communicating assertively helps set boundaries without escalating the situation!'
    },
    {
      id: 2,
      ...
      correct: 'a',
      explanation: 'Standing firm on your priorities protects your goals and shows self-respect. True friends will understand!'
    },
    {
      id: 3,
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Peer Pressure Story game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
