...
const DebateRoteVsUnderstanding = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      correct: 'a',
      explanation: 'Understanding concepts allows you to tackle unfamiliar questions by applying principles, while rote learning only works for exact matches!'
    }
  ];
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Debate: Rote vs Understanding game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
