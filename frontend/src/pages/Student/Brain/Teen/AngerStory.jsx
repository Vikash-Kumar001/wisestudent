...
const AngerStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Teen argues with sibling. Best action?",
      choices: [
        { id: 'a', text: 'Take break, then talk' },
        { id: 'b', text: 'Keep fighting' },
        { id: 'c', text: 'Give silent treatment' }
      ],
      correct: 'a',
      explanation: 'Taking a break allows emotions to cool down, making productive communication possible!'
    },
    {
      id: 2,
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Anger Story game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
