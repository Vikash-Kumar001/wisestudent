...
const MidnightStory = () => {
  ...
  const questions = [
    {
      id: 1,
      text: "Teen scrolls till 1 AM, tired next day. Smart?",
      choices: [
        { id: 'a', text: 'No, it disrupts sleep and next-day performance' },
        { id: 'b', text: 'Yes, it\'s fine to scroll late' },
        { id: 'c', text: 'Maybe, depends on the person' }
      ],
      correct: 'a',
      explanation: 'No! Scrolling until 1 AM disrupts your sleep schedule, reduces sleep quality, and leaves you tired and unfocused the next day!'
    },
    {
      id: 2,
  ...
  useEffect(() => {
    if (levelCompleted) {
      console.log(`🎮 Midnight Story game completed! Score: ${score}/${questions.length}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
