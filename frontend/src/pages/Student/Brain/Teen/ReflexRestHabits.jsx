...
const ReflexRestHabits = () => {
  ...
  useEffect(() => {
    if (gameState === "finished") {
      console.log(`🎮 Reflex Rest Habits game completed! Score: ${finalScore}/${TOTAL_ROUNDS}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about healthy rest habits!<br />
        ...
        {gameState === "finished" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-lg text-white/80 mb-6">
              {finalScore === TOTAL_ROUNDS ? "Perfect score! Great rest habits!" : 
               finalScore >= TOTAL_ROUNDS / 2 ? "Good job! You have healthy rest habits!" : 
               "Keep practicing to improve your rest habits!"}
            </p>
            <button
              onClick={() => {
                setGameState("ready");
