...
const ReflexHealthyUse = () => {
  ...
  useEffect(() => {
    if (gameState === "finished") {
      console.log(`🎮 Reflex Healthy Use game completed! Score: ${finalScore}/${TOTAL_ROUNDS}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  return (
    <GameShell
      ...
      subtitle={gameState === "playing" ? `Round ${currentRound}/${TOTAL_ROUNDS}: Test your healthy use reflexes!` : "Test your healthy use reflexes!"}
        ...
        {gameState === "ready" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-white/90 text-lg mb-6">
              Answer questions about healthy digital habits!<br />
        ...
        {gameState === "finished" && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center">
            ...
            <p className="text-lg text-white/80 mb-6">
              {finalScore === TOTAL_ROUNDS ? "Perfect score! Great digital habits!" : 
               finalScore >= TOTAL_ROUNDS / 2 ? "Good job! You have healthy digital habits!" : 
               "Keep practicing to improve your digital wellness!"}
            </p>
            <button
              onClick={() => {
                setGameState("ready");
