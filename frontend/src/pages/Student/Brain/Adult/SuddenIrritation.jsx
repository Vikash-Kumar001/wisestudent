...
const choices = [
  {
    id: "a",
    title: "React immediately with frustration.",
    outcome: "Conflict increases.",
  },
  {
    id: "b",
    title: "Pause and notice the emotion.",
    outcome: "Awareness improves.",
  },
  {
    id: "c",
    title: "Suppress the feeling.",
...
const SuddenIrritation = () => {
  const location = useLocation();
  const gameId = "brain-adults-21"; // Twenty-first brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Emotional awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Sudden Irritation", { score });
    }
  }, [skillUnlocked, score]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Small comments feel unusually heavy.
        </Section>
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Emotional awareness</strong>
          </Section>
        )}
...
export default SuddenIrritation;