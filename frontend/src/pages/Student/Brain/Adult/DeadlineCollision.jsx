...
const choices = [
  {
    id: "a",
    title: "Rush through everything.",
    outcome: "Errors and stress increase.",
  },
  {
    id: "b",
    title: "Re-evaluate priorities calmly.",
    outcome: "Control improves.",
  },
  {
    id: "c",
    title: "Delay decisions.",
...
const DeadlineCollision = () => {
  const location = useLocation();
  const gameId = "brain-adults-4"; // Fourth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Adaptive planning awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Deadline Collision", { score });
    }
  }, [skillUnlocked, score]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Fear of dropping responsibilities.
        </Section>
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Adaptive planning awareness</strong>
          </Section>
        )}
...
export default DeadlineCollision;