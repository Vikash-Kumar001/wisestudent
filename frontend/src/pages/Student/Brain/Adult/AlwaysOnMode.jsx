...
const choices = [
  {
    id: "a",
    title: "Stay alert and responsive at all times.",
    outcome: "Mental fatigue builds steadily.",
  },
  {
    id: "b",
    title: "Mentally disengage after work hours.",
    outcome: "Mental space improves gradually.",
  },
  {
    id: "c",
    title: "Ignore the discomfort and continue as usual.",
...
const AlwaysOnMode = () => {
  ...
  const gameId = "brain-adults-1"; // Assuming this will be the second brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Mental boundary awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Always On Mode", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond mentally after work hours"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Messages and pending tasks create constant mental presence.
        </Section>

        {/* Decision */}
        <Section title="Decision Moment">
          The person must decide how to respond mentally after work hours.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Mental boundary awareness</strong>
          </Section>
        )}
