...
const choices = [
  {
    id: "a",
    title: "Engage with every worry.",
    outcome: "Anxiety escalates.",
  },
  {
    id: "b",
    title: "Notice thoughts and refocus.",
    outcome: "Mental calm improves.",
  },
  {
    id: "c",
    title: "Force thoughts away.",
...
const WhatIfLoop = () => {
  ...
  const gameId = "brain-adults-13"; // Thirteenth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Thought pattern awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed What If Loop", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to respond mentally"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Uncontrolled "what if" thoughts.
        </Section>

        {/* Decision */}
        <Section title="Decision Moment">
          The person must choose how to respond mentally.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Thought pattern awareness</strong>
          </Section>
        )}
