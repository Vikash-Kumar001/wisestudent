...
const choices = [
  ...
  {
    id: "b",
    title: "Notice and reflect on it.",
    outcome: "Awareness increases.",
  },
  {
    id: "c",
    title: "Force emotional reactions.",
...
const FeelingDisconnected = () => {
  ...
  const gameId = "brain-adults-24"; // Twenty-fourth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Emotional sensitivity awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Feeling Disconnected", { score });
    }
  }, [skillUnlocked, score]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Prolonged pressure and routine.
        </Section>
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Emotional sensitivity awareness</strong>
          </Section>
        )}
