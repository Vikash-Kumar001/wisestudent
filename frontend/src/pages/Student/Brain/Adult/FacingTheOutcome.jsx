...
const FacingTheOutcome = () => {
  const location = useLocation();
  const gameId = "brain-adults-20"; // Twentieth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Outcome resilience awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Facing the Outcome", { score });
    }
  }, [skillUnlocked, score]);
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Outcome resilience awareness</strong>
          </Section>
        )}
...
export default FacingTheOutcome;