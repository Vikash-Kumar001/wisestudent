...
const choices = [
  ...
  {
    id: "b",
    title: "Focus on personal pace.",
    outcome: "Stability improves.",
  },
  {
    id: "c",
    title: "Withdraw from comparison.",
...
const FearOfFallingBehind = () => {
  const location = useLocation();
  const gameId = "brain-adults-14"; // Fourteenth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Self-paced growth awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Fear of Falling Behind", { score });
    }
  }, [skillUnlocked, score]);
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Self-paced growth awareness</strong>
          </Section>
        )}
...
export default FearOfFallingBehind;