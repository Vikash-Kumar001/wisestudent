...
const choices = [
  ...
  {
    id: "b",
    title: "Explore options gradually.",
    outcome: "Clarity improves over time.",
  },
  {
    id: "c",
    title: "Follow others' paths.",
...
const UnclearFuture = () => {
  ...
  const gameId = "brain-adults-17"; // Seventeenth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Future clarity awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Unclear Future", { score });
    }
  }, [skillUnlocked, score]);
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Future clarity awareness</strong>
          </Section>
        )}
