...
const choices = [
  {
    id: "a",
    title: "Express anger immediately.",
...
const AngerWithoutWarning = () => {
  const location = useLocation();
  const gameId = "brain-adults-25"; // Twenty-fifth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Anger awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Anger Without Warning", { score });
    }
  }, [skillUnlocked, score]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Underlying stress surfaces suddenly.
        </Section>
...
export default AngerWithoutWarning;