...
const choices = [
  {
    id: "a",
    title: "Release stress at home.",
    outcome: "Relationship tension increases.",
  },
  {
    id: "b",
    title: "Recognise spillover and pause.",
...
const CarryingItHome = () => {
  const location = useLocation();
  const gameId = "brain-adults-5"; // Fifth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Spillover awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Carrying It Home", { score });
    }
  }, [skillUnlocked, score]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Unresolved work pressure spills into personal life.
        </Section>
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Spillover awareness</strong>
          </Section>
        )}
