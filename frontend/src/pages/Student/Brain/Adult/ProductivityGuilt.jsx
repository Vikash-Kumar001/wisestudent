...
const choices = [
  {
    id: "a",
    title: "Self-criticise for resting.",
    outcome: "Mental pressure increases.",
  },
  {
    id: "b",
    title: "Accept rest as necessary.",
    outcome: "Balance improves.",
  },
  {
    id: "c",
    title: "Avoid resting completely.",
...
const ProductivityGuilt = () => {
  ...
  const gameId = "brain-adults-6"; // Sixth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Rest perception awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Productivity Guilt", { score });
    }
  }, [skillUnlocked, score]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to interpret rest.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Rest perception awareness</strong>
          </Section>
        )}
