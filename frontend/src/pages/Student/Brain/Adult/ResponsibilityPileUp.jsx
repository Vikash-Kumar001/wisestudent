...
const choices = [
  {
    id: "a",
    title: "Try to handle everything without adjustment.",
    outcome: "Exhaustion increases.",
  },
  {
    id: "b",
    title: "Acknowledge limits and prioritise.",
    outcome: "Control improves slowly.",
  },
  {
    id: "c",
    title: "Avoid thinking about the pressure.",
...
const ResponsibilityPileUp = () => {
  const location = useLocation();
  const gameId = "brain-adults-2"; // Second brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Capacity awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Responsibility Pile-Up", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how you respond to the overload"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Multiple responsibilities demand attention at the same time.
        </Section>

        {/* Decision */}
        <Section title="Decision Moment">
          The person must choose how to respond to the overload.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Capacity awareness</strong>
          </Section>
        )}
...
export default ResponsibilityPileUp;