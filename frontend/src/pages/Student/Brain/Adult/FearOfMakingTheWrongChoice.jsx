...
const choices = [
  {
    id: "a",
    title: "Delay the decision repeatedly.",
    outcome: "Stress builds over time.",
  },
  {
    id: "b",
    title: "Decide with available information.",
    outcome: "Confidence stabilises.",
  },
  {
    id: "c",
    title: "Let others decide.",
...
const FearOfMakingTheWrongChoice = () => {
  const location = useLocation();
  const gameId = "brain-adults-12"; // Twelfth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Decision confidence awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Fear of Making the Wrong Choice", { score });
    }
  }, [skillUnlocked, score]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must decide how to choose.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Decision confidence awareness</strong>
          </Section>
        )}
...
export default FearOfMakingTheWrongChoice;