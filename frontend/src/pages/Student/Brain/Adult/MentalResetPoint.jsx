...
const MentalResetPoint = () => {
  const location = useLocation();
  const gameId = "brain-adults-10"; // Tenth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Mental reset awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Mental Reset Point", { score });
    }
  }, [skillUnlocked, score]);
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Mental reset awareness</strong>
          </Section>
        )}
...
export default MentalResetPoint;