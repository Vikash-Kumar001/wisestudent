...
const choices = [
  {
    id: "a",
    title: "Ignore uncomfortable feelings.",
    outcome: "Confusion remains.",
  },
  {
    id: "b",
    title: "Acknowledge both emotions.",
    outcome: "Clarity improves.",
  },
  {
    id: "c",
    title: "Focus only on anxiety.",
...
const MixedFeelings = () => {
  ...
  const gameId = "brain-adults-22"; // Twenty-second brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Emotional clarity");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Mixed Feelings", { score });
    }
  }, [skillUnlocked, score]);
        ...
        skillUnlocked
          ...
          : showSecondReflection && !secondReflectionCompleted
            ...
            : showFirstReflection && !firstReflectionCompleted
              ...
              : "Choose how to process emotions"
      }
      score={score}
      currentLevel={1}
      totalLevels={1}
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Conflicting emotions create confusion.
        </Section>

        {/* Decision */}
        <Section title="Decision Moment">
          The person must choose how to process emotions.
