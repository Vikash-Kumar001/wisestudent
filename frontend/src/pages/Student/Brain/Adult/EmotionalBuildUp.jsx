...
const choices = [
  {
    id: "a",
    title: "Release emotions suddenly.",
    outcome: "Relief followed by discomfort.",
  },
  {
    id: "b",
    title: "Address emotions gradually.",
...
const EmotionalBuildUp = () => {
  ...
  const gameId = "brain-adults-23"; // Twenty-third brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Emotional regulation awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Emotional Build-Up", { score });
    }
  }, [skillUnlocked, score]);
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Emotional regulation awareness</strong>
          </Section>
        )}
