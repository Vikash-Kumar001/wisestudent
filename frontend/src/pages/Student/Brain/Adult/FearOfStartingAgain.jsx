...
const choices = [
  {
    id: "a",
    title: "Avoid starting again.",
    outcome: "Regret increases.",
  },
  {
    id: "b",
    title: "Begin with a small step.",
    outcome: "Confidence builds gradually.",
  },
  {
    id: "c",
    title: "Wait for confidence.",
...
const FearOfStartingAgain = () => {
  const location = useLocation();
  const gameId = "brain-adults-15"; // Fifteenth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Restart awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Fear of Starting Again", { score });
    }
  }, [skillUnlocked, score]);
      ...
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Restart awareness</strong>
          </Section>
        )}
...
export default FearOfStartingAgain;