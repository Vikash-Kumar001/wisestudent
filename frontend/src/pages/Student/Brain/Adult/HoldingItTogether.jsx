...
const choices = [
  {
    id: "a",
    title: "Hide all struggles.",
    outcome: "Internal stress builds.",
  },
  {
    id: "b",
    title: "Acknowledge inner strain.",
    outcome: "Self-awareness improves.",
  },
  {
    id: "c",
    title: "Distract with busyness.",
...
const HoldingItTogether = () => {
  const location = useLocation();
  const gameId = "brain-adults-8"; // Eighth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Skill unlocked: Emotional honesty awareness");
    }
  }, [skillUnlocked]);

  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Holding It Together", { score });
    }
  }, [skillUnlocked, score]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Decision Moment">
          The person must choose how to handle emotions.
        ...
        {skillUnlocked && (
          <Section title="Skill / Insight Unlocked">
            <strong>Emotional honesty awareness</strong>
          </Section>
        )}
...
export default HoldingItTogether;