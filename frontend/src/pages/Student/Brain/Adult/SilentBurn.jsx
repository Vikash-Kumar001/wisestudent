...
const choices = [
  {
    id: "a",
    title: "Ignore the feeling and keep going.",
    outcome: "Burnout risk increases.",
  },
  {
    id: "b",
    title: "Notice the change in energy.",
    outcome: "Awareness improves.",
  },
  {
    id: "c",
    title: "Distract with constant activity.",
...
const SilentBurn = () => {
  ...
  const gameId = "brain-adults-3"; // Third brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Silent Burn", { score });
    }
  }, [skillUnlocked, score]);
    ...
    >
      <div className="space-y-6 max-w-4xl mx-auto p-4">
        ...
        <Section title="Stress Point">
          Ongoing stress without visible breakdown.
        </Section>
