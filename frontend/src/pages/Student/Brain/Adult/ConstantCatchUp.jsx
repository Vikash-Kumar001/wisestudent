...
const ConstantCatchUp = () => {
  const location = useLocation();
  const gameId = "brain-adults-9"; // Ninth brain-adults game
  ...
  useEffect(() => {
    if (skillUnlocked) {
      console.log("Completed Constant Catch-Up", { score });
    }
  }, [skillUnlocked, score]);
...
export default ConstantCatchUp;