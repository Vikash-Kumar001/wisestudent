...
const SimulationSustainableShopping = () => {
  ...
  useEffect(() => {
    if (gameFinished) {
      console.log(`🎮 Simulation: Sustainable Shopping game completed! Score: ${coins}, Correct Answers: ${correctAnswers}, gameId: ${gameId}, nextGamePath: ${nextGamePath}, nextGameId: ${nextGameId}`);
  ...
  const handleChoice = (optionId) => {
    ...
    if (isCorrect) {
      // With our global variables set correctly, pass 1 to get 1 * 1 = 1
