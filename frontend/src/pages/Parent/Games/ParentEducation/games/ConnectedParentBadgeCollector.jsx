...
import { Award, CheckCircle, Lock, Sparkles, Users } from "lucide-react";
...
const ConnectedParentBadgeCollector = () => {
  ...
  if (!allCompleted) {
    return (
      <ParentGameShell
        title={gameData?.title || "Connected Parent Badge"}
        subtitle="Locked - Complete all connection activities to unlock"
        showGameOver={false}
        score={0}
        gameId={gameId}
        gameData={gameData}
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">
                Complete all 5 connection activities to unlock this badge
              </p>
            </div>
            ...
            <div className="mb-6">
              <div className="flex justify-between text-sm text-gray-600 mb-2">
                <span>Progress</span>
                <span>{gamesStatus.filter(g => g.completed).length} / 5 connection activities completed</span>
              </div>
  ...
  return (
    <ParentGameShell
      title={gameData?.title || "Connected Parent Badge"}
      subtitle="Celebrate consistent efforts to nurture supportive relationships"
      showGameOver={false}
      score={0}
      gameId={gameId}
      gameData={gameData}
        ...
        {badgeCollected ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-200 mb-6">
              <p className="text-gray-700 text-lg">
                Congratulations! You have successfully completed all connection activities and earned the Connected Parent Badge.
              </p>
            </div>

            {/* Completed Games List */}
            <div className="bg-gray-50 rounded-xl p-6 mb-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Completed Connection Activities:</h3>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
              <p className="text-sm text-amber-800">
                <strong>💡 Parent Tip:</strong> Keep your connection badge visible—remind yourself daily: you are never alone. 
                Your consistent efforts to nurture supportive relationships create a foundation of connection that strengthens your family. 
                This invisible strength is one of the most powerful gifts you can give your children.
              </p>
            </div>
          </div>
        ) : (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-2">
                All Connection Activities Completed!
              </h2>
              <p className="text-lg text-gray-600 mb-4">
                You've successfully completed all 5 connection activities
              </p>
            </div>

            {/* Completed Games List */}
            <div className="bg-gray-50 rounded-xl p-6 mb-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4 text-center">Completed Connection Activities:</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {gamesStatus.map((game) => (
                  <motion.div
                    key={game.gameId}
            ...
            <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-xl p-8 border-2 border-green-300 mb-6 text-center">
              ...
              <p className="text-gray-600">
                This badge recognizes your consistent efforts to nurture supportive relationships and build strong connections.
              </p>
            </div>
