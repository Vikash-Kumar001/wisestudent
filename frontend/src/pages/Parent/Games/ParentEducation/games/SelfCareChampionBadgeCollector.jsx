...
const SelfCareChampionBadgeCollector = () => {
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="mb-6">
              <div className="flex justify-between text-sm text-gray-600 mb-2">
                <span>Progress</span>
                <span>{gamesStatus.filter(g => g.completed).length} / 5 self-care activities completed</span>
              </div>
  ...
  return (
    <ParentGameShell
      title={gameData?.title || "Self-Care Champion Badge"}
      subtitle="Celebrate parents who consistently model self-care and digital discipline"
      showGameOver={false}
      score={0}
      gameId={gameId}
      gameData={gameData}
        ...
        {badgeCollected ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-200 mb-6">
              <p className="text-gray-700 text-lg">
                Congratulations! You have successfully completed all self-care activities and earned the Self-Care Champion Badge.
              </p>
            </div>

            {/* Completed Games List */}
            <div className="bg-gray-50 rounded-xl p-6 mb-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Completed Self-Care Activities:</h3>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
              <p className="text-sm text-amber-800">
                <strong>💡 Parent Tip:</strong> Display your badge at home — a visual reminder that calmness is contagious. 
                When you consistently model self-care and digital discipline, you're teaching your children more than habits—you're teaching them how to live with peace. 
                Your self-care isn't selfish—it's instructional. Every time you rest, disconnect, recharge, and honor your boundaries, 
                you're showing your children that self-care is normal, necessary, and non-negotiable. Display your badge proudly as a reminder that calmness is contagious. 
                Your peace becomes their peace. Your self-care becomes their model for life.
              </p>
            </div>
          </div>
        ) : (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-2">
                All Self-Care Activities Completed!
              </h2>
              <p className="text-lg text-gray-600 mb-4">
                You've successfully completed all 5 self-care activities
              </p>
            </div>

            {/* Completed Games List */}
            <div className="bg-gray-50 rounded-xl p-6 mb-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4 text-center">Completed Self-Care Activities:</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {gamesStatus.map((game) => (
                  <motion.div
                    key={game.gameId}
            ...
            <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-xl p-8 border-2 border-green-300 mb-6 text-center">
              ...
              <p className="text-gray-600">
                This badge recognizes your commitment to modeling self-care and digital discipline.
              </p>
            </div>
            ...
            <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-4 text-center">
              <p className="text-sm text-amber-800">
                <strong>💡 Parent Tip:</strong> Display your badge at home — a visual reminder that calmness is contagious. 
                When you consistently care for yourself—resting, disconnecting, recharging, setting boundaries—you're teaching your children how to live with peace.
              </p>
            </div>
          </div>
        )}
