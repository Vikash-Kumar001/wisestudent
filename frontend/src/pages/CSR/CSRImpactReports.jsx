...
const DEFAULT_NOTE =
  "Reports are generated by WiseStudent and cannot be edited. Contact support if you need corrections.";
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">
                Download reports for your CSR/ESG annual reporting.
              </p>
            </div>
            <button
              onClick={handleRefresh}
        ...
        <section className="grid gap-4 md:grid-cols-1 lg:grid-cols-3">
          <article className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm space-y-4 hover:shadow-md transition-shadow">
          ...
          <article className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm space-y-4 hover:shadow-md transition-shadow">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-emerald-500 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-emerald-600 hover:bg-emerald-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                <Download className="w-4 h-4" />
